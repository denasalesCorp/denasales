...
public class DefaultDenasalesservicesService implements DenasalesservicesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultDenasalesservicesService.class);
	...
	{
		return DefaultDenasalesservicesService.class.getResourceAsStream("/denasalesservices/sap-hybris-platform.png");
	}
