 ...
 */
package com.denasales.services.jalo;
...
/**
 * This is the extension manager of the Denasalesservices extension.
 */
public class DenasalesservicesManager extends GeneratedDenasalesservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(DenasalesservicesManager.class);
	 ...
	 */
	public static DenasalesservicesManager getInstance()
	{
		return (DenasalesservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(DenasalesservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public DenasalesservicesManager() // NOPMD 
	{
		LOG.debug("constructor of DenasalesservicesManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of DenasalesservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of DenasalesservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
