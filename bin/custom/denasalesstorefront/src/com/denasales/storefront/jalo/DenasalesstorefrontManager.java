 ...
 */
package com.denasales.storefront.jalo;
...
/**
 * This is the extension manager of the Denasalesstorefront extension.
 */
public class DenasalesstorefrontManager extends GeneratedDenasalesstorefrontManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(DenasalesstorefrontManager.class);
	 ...
	 */
	public static DenasalesstorefrontManager getInstance()
	{
		return (DenasalesstorefrontManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(DenasalesstorefrontConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public DenasalesstorefrontManager() // NOPMD 
	{
		LOG.debug("constructor of DenasalesstorefrontManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of DenasalesstorefrontManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of DenasalesstorefrontManager called, current tenant: {}", getTenant().getTenantID());
	}
