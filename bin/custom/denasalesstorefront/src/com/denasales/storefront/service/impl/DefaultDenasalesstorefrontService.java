...
public class DefaultDenasalesstorefrontService implements DenasalesstorefrontService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultDenasalesstorefrontService.class);
	...
	{
		return DefaultDenasalesstorefrontService.class.getResourceAsStream("/denasalesstorefront/sap-hybris-platform.png");
	}
