...
public class DefaultDenasalesfacadesService implements DenasalesfacadesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultDenasalesfacadesService.class);
	...
	{
		return DefaultDenasalesfacadesService.class.getResourceAsStream("/denasalesfacades/sap-hybris-platform.png");
	}
