 ...
 */
package com.denasales.facades.jalo;
...
/**
 * This is the extension manager of the Denasalesfacades extension.
 */
public class DenasalesfacadesManager extends GeneratedDenasalesfacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(DenasalesfacadesManager.class);
	 ...
	 */
	public static DenasalesfacadesManager getInstance()
	{
		return (DenasalesfacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(DenasalesfacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public DenasalesfacadesManager() // NOPMD 
	{
		LOG.debug("constructor of DenasalesfacadesManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of DenasalesfacadesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of DenasalesfacadesManager called, current tenant: {}", getTenant().getTenantID());
	}
