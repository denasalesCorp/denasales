 ...
 */
package com.denasales.cockpit.jalo;
...
import com.denasales.cockpit.constants.DenasalescockpitConstants;


/**
 * This is the extension manager of the denasalescockpit extension.
 */
public class DenasalescockpitManager extends GeneratedDenasalescockpitManager
{
	/**
	 * Edit the local|project.properties to change logging behavior (properties 'log4j.*').
	 */
	@SuppressWarnings("unused")
	private final static Logger LOG = Logger.getLogger(DenasalescockpitManager.class.getName());
	 ...
	 */
	public static final DenasalescockpitManager getInstance()
	{
		return (DenasalescockpitManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(DenasalescockpitConstants.EXTENSIONNAME);
	}
