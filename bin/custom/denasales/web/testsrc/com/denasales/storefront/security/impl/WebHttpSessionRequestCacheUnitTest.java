...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/denasales/electronics/en",
						"https://electronics.local:9002/denasales/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/denasales/electronics/en",
						"https://electronics.local:9002/denasales/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/denasales/electronics/ja/Y/Z",
						"https://electronics.local:9002/denasales/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/denasales/electronics/en",
						"https://electronics.local:9002/denasales/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/denasales",
						"https://electronics.local:9002/denasales"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/denasales",
						"https://electronics.local:9002/denasales/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/denasales/electronics/en",
						"https://electronics.local:9002/denasales/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
