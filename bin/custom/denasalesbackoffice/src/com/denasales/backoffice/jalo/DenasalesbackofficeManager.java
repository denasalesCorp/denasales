 ...
 */
package com.denasales.backoffice.jalo;
...
import com.denasales.backoffice.constants.DenasalesbackofficeConstants;
 ...
 */
public class DenasalesbackofficeManager extends GeneratedDenasalesbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(DenasalesbackofficeManager.class.getName());
	 ...
	 */
	public static DenasalesbackofficeManager getInstance()
	{
		return (DenasalesbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(DenasalesbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public DenasalesbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of DenasalesbackofficeManager called.");
		}
	}
